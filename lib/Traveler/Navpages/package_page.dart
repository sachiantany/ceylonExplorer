...
class _PackagePageState extends State<PackagePage> with TickerProviderStateMixin {
  var images ={
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  IconButton(
                    ...
                    icon: const Icon( Icons.menu, size: 30, color: AppColors.buttonBackground1,
                    ),
                  ),
            ...
            Container(
              ...
              child: AppLargeText(text: "Select Your Journey",size: 30, color: AppColors.textColor1,),
            ),
